!(function (t, e) {
    ...
    (It.text = It.email = It.password = It.number = It.tel = It.url = function (t, e) {
        return (
            "string" == typeof e.inputValue || "number" == typeof e.inputValue ? (t.value = e.inputValue) : b(e.inputValue) || z('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
                St(t, e),
                (t.type = e.input),
                t
        );
    ...
    function Dt(t, s) {
        ...
        l >= s.progressSteps.length && z("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
            s.progressSteps.forEach(function (t, e) {
                ...
                e !== s.progressSteps.length - 1 && ((r = s), (a = document.createElement("li")), gt(a, Q["progress-step-line"]), r.progressStepsDistance && (a.style.width = r.progressStepsDistance), (i = a), u.appendChild(i));
            });
    }
    function Ht(t, e) {
        var n,
    ...
    function me(t, e, n, o) {
        ...
        U(document.body, Q.iosfix) && ((i = parseInt(document.body.style.top, 10)), vt(document.body, Q.iosfix), (document.body.style.top = ""), (document.body.scrollTop = -1 * i)),
    ...
    function ke(t) {
        ...
        !t.preConfirm &&
        z("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"),
            (t.animation = Y(t.animation)),
        ((n = t).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild)) || (z('Target parameter is not valid, defaulting to "body"'), (n.target = "body")),
    ...
    var ln,
        ...
        pn = Object.freeze({
            ...
            _main: function (t) {
                ...
                var n = (function (t) {
                    var e = { popup: X(), container: J(), content: x(), actions: j(), confirmButton: E(), denyButton: O(), cancelButton: L(), loader: T(), closeButton: V(), validationMessage: S(), progressSteps: A() };
        ...
        fn = (function () {
            function r() {
                if ((a(this, r), "undefined" != typeof window)) {
                    ...
                    W("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"),
                        (ln = this);
                    for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
